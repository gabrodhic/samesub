<?php
//This class overrides the beforeControllerAction method, to intercept all REQUESTS made to the API
//and require authorization or not depending on the action executed as defined

/*
More on oauth:
http://www.yiiframework.com/extension/api-module
http://www.lockphp.com/api
    ...
    */
	...
	public function beforeControllerAction($controller, $action)
	{
		if(parent::beforeControllerAction($controller, $action))
		{
			...
			Yii::app()->params['api_request'] = true;//This is to indicate to some models its an api request(ie:a captcha not to be used in subject add form since is an api request)
