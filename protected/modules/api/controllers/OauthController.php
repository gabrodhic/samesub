...
class OauthController extends Controller
{
    ...
    */
	public function actionAccess_token()
	{
        ...
        if($x_auth_mode == 'client_auth')
        {
            ...
            $model=new LoginForm;
            $arr = array(
                'username'=>urldecode($username), //urldecode, as some characters(i.e. an '@' in an email username) can get encoded in the url REQUEST
    ...
    */
	public function actionAuthorize()
	{
        ...
        $this->renderPartial('Authorize',$data);
	}
}
