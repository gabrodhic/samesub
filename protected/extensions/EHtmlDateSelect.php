        ...
        public function run()
        {
                ...
                if ($this->display_months)
                {
                        ...
                        $month_result .= $this->html_options(
                                                              array(
                                                                    'output'     => $month_names,
                                                                    'values'     => $month_values,
                                                                    'selected'   => (!$this->year_empty) ? strftime($this->month_value_format, mktime(0, 0, 0, (int)$this->time[1], 1, 2000)) : '',
                                                                    'print_result' => false
                                                                   )
                                                            );
                        $month_result .= '</select>';
                ...
                if ($this->display_days)
                {
                        ...
                        $day_result .= $this->html_options(array('output'     => $days,
                                                          'values'     => $day_values,
                                                          'selected'   => (!$this->year_empty) ? $this->time[2]:'',
                                                          'print_result' => false)
                                                    );
                        $day_result .= '</select>';
                }
                ...
                if ($this->display_years)
                {
                        ...
                        else
                        {
                                ...
                                $year_result .= $this->html_options(array('output' => $years,
                                                               'values' => $yearvals,
                                                               'selected'   => (!$this->year_empty) ? $this->time[0]:'',
                                                               'print_result' => false)
                                                         );
                                $year_result .= '</select>';
                        }
