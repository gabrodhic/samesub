...
var baseUrl = "http://localhost/samesub";
	...
	if(pending_comment == true){
		...
		for(var i in comments) {			
			...
			comment_number = comments[i]['comment_number'].toString();//cast it as string
				...
				new_line += '<span class="comment_username"><a href="http://localhost/samesub/mysub/'+ comments[i]['username'] +'">'+ comments[i]['username'] + '</a></span>';				
...
function get_Contents(callback){
	...
	ajax_request(
		...
		function(json){
			...
			var aa = setTimeout("get_Contents()",5000);//(add the javascript milliseconds) Everythig loaded ok, lets make a new request to watch for new changes
		...
		function(){
			...
			var bb = setTimeout("get_Contents()",5000 + 5000);//There was an error loading content, lets make a new request to try to get content again
		}
	);
}
...
$(document).ready(function() {
        ...
        $('.comment_like_button, .comment_dislike_button').die('click').live('click',function() {
			...
			var link = '/samesub/api/v1/comment/vote?comment_id='+$(this).attr('alt')+'&vote=';			
        ...
        $('.sub_like_button, .sub_dislike_button').die('click').live('click',function() {
			...
			var link = '/samesub/api/v1/subject/vote?subject_id='+$(this).attr('alt')+'&vote=';			
...
function display_elements(obj_json){
	...
	submit_info = 'by <a href="http://localhost/samesub/mysub/'+obj_json.username+'">' + obj_json.username + '</a> at '+time_submitted.getHours()+':'+time_submitted.getMinutes()+' UTC';
	share_links = '<a target="_blank" href="http://api.addthis.com/oexchange/0.8/forward/facebook/offer?url=http://localhost/samesub/sub/'+obj_json.urn+'&title='+obj_json.title+'&pubid=" rel="nofollow"><img src="http://cache.addthiscdn.com/icons/v1/thumbs/facebook.gif"></a>&nbsp;<a target="_blank" href="http://api.addthis.com/oexchange/0.8/forward/twitter/offer?url=http://localhost/samesub/sub/'+obj_json.urn+'&title='+obj_json.title+'&pubid=" rel="nofollow"><img src="http://cache.addthiscdn.com/icons/v1/thumbs/twitter.gif"></a>&nbsp;<a target="_blank" href="http://api.addthis.com/oexchange/0.8/forward/email/offer?url=http://localhost/samesub/sub/'+obj_json.urn+'&title='+obj_json.title+'&pubid=" rel="nofollow"><img src="http://cache.addthiscdn.com/icons/v1/thumbs/email.gif"></a>&nbsp;<a target="_blank" href="http://api.addthis.com/oexchange/0.8/forward/google/offer?url=http://localhost/samesub/sub/'+obj_json.urn+'&title='+obj_json.title+'&pubid=" rel="nofollow"><img src="http://cache.addthiscdn.com/icons/v1/thumbs/google.gif"></a>&nbsp;<a target="_blank" href="http://api.addthis.com/oexchange/0.8/offer?url=http://localhost/samesub/sub/'+obj_json.urn+'&title='+obj_json.title+'&pubid=" rel="nofollow"><img src="http://cache.addthiscdn.com/icons/v1/thumbs/menu.gif"></a><br>';
...
$(document).ready(function() {
	get_Contents(function(){
		...
		$('<iframe src="about:blank" width="980" height="900" id="frame_box" frameBorder="0" scrolling="no" style="display:none; background-color:white; z-index:9000; position:absolute;"></iframe>').prependTo('#main_body');
		 setTimeout(function (){
		 $('#frame_box').contents().find('body').html('<p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center"><b><font size="7" face="Trebuchet MS" color="#3F3F3F">Next sub is:</font></b></p><p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center" style="font: normal 14px Trebuchet MS, Arial, Helvetica, sans-serif; color:#3F3F3F;"><b><a target="_top" href="http://localhost/samesub/subject/add">You can add your own sub here</a></b></p>');
		 },3000); 
