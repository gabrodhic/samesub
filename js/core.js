...
function send_comment(){
	if ($('#comment_textarea').val().length > 0){
		ajax_request(
			...
			function(){ },
			function(){$("#comment_status").show(); $("#comment_status").html(ssLang.site.errorSendingComment); },
			"POST"
		);
	}
}
	...
	if(pending_comment == true){
		...
		for(var i in comments) {			
			...
			comment_number = comments[i]['comment_number'].toString();//cast it as string
				...
				new_line += '<span class="comment_username"><a href="'+ssBaseUrl+'/mysub/'+ comments[i]['username'] +'">'+ comments[i]['username'] + '</a></span>';				
...
function display_elements(obj_json){
	...
	submit_info = '<a href="'+ssBaseUrl+'/mysub/'+obj_json.username+'">' + obj_json.username + '</a> '+time_submitted.getHours()+':'+time_submitted.getMinutes()+' UTC';
	share_links = '<a target="_blank" href="'+ssAddThisLinkUrl+'/forward/facebook/offer?url='+ssBaseUrl+'/sub/'+obj_json.urn+'&title='+obj_json.title+'&pubid=" rel="nofollow"><img src="'+ssAddThisImgUrl+'/facebook.gif"></a>&nbsp;<a target="_blank" href="'+ssAddThisLinkUrl+'/forward/twitter/offer?url='+ssBaseUrl+'/sub/'+obj_json.urn+'&title='+obj_json.title+'&pubid=" rel="nofollow"><img src="'+ssAddThisImgUrl+'/twitter.gif"></a>&nbsp;<a target="_blank" href="'+ssAddThisLinkUrl+'/email/offer?url='+ssBaseUrl+'/sub/'+obj_json.urn+'&title='+obj_json.title+'&pubid=" rel="nofollow"><img src="'+ssAddThisImgUrl+'/email.gif"></a>&nbsp;<a target="_blank" href="'+ssAddThisLinkUrl+'/forward/google/offer?url='+ssBaseUrl+'/sub/'+obj_json.urn+'&title='+obj_json.title+'&pubid=" rel="nofollow"><img src="'+ssAddThisImgUrl+'/google.gif"></a>&nbsp;<a target="_blank" href="'+ssAddThisLinkUrl+'/offer?url='+ssBaseUrl+'/sub/'+obj_json.urn+'&title='+obj_json.title+'&pubid=" rel="nofollow"><img src="'+ssAddThisImgUrl+'/menu.gif"></a><br>';
	$('#subject_voting').html( '<div style="float:left;width:200px;"><div style="float:right;"><span class=""> <a class="sub_like_button" alt="'+obj_json.subject_id+'"></a> <em class="sub_vote_label" style="margin-right:10px;">Like</em> <a class="sub_dislike_button"  alt="'+obj_json.subject_id+'"></a> <em class="sub_vote_label">Dislike</em></span></div><div style="clear:both"></div><div class="sub_vote_percentbar_dislikes" style="width:200px;"><div class="sub_vote_percentbar_likes" style="width:0px;"></div></div><div id="sub_likes_dislikes" style="text-align:right;">'+obj_json.likes+' likes, '+obj_json.dislikes+' dislikes</div></div><div id="sub_likes_percent" style="float:left; text-align:center; margin:0 15px 0 15px; background:grey; color:white;padding:2px;font-weight:bold;">0%</div>');;
	...
	$('#content_div_1').html(''+obj_json.content_html+'<br>'+obj_json.user_comment+'<br><br><br><br> ');
...
$(document).ready(function() {
	get_Contents(function(){
		...
		$('<iframe src="about:blank" width="980" height="900" id="frame_box" frameBorder="0" scrolling="no" style="display:none; background-color:white; z-index:9000; position:absolute;"></iframe>').prependTo('#main_body');
		 setTimeout(function (){
		 $('#frame_box').contents().find('body').html('<p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center"><b><font size="7" face="Trebuchet MS" color="#3F3F3F">Next sub is:</font></b></p><p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center">&nbsp;</p><p align="center" style="font: normal 14px Trebuchet MS, Arial, Helvetica, sans-serif; color:#3F3F3F;"><b><a target="_top" href="'+ssBaseUrl+'/subject/add">You can add your own sub here</a></b></p>');
		 },3000); 
